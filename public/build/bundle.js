    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t44 = space();
    			p3 = element("p");
    			t45 = text("Download these 2 files, and move them into the ");
    			i2 = element("i");
    			i2.textContent = "src";
    			t47 = text(" folder of your project");
    			t48 = space();
    			button2 = element("button");
    			t49 = text(/*button1Text*/ ctx[3]);
    			t50 = space();
    			br2 = element("br");
    			t51 = space();
    			button3 = element("button");
    			t52 = text(/*button2Text*/ ctx[4]);
    			t53 = space();
    			br3 = element("br");
    			t54 = space();
    			div6 = element("div");
    			...
    			p5 = element("p");
    			t59 = text("import ");
    			t60 = text(/*className*/ ctx[2]);
    			t61 = text(" from './");
    			t62 = text(/*className*/ ctx[2]);
    			t63 = text(".svelte'");
    			t64 = space();
    			br4 = element("br");
    			t65 = space();
    			...
    			add_location(ul1, file$2, 201, 4, 4406);
    			attr_dev(div0, "id", "step0");
    			attr_dev(div0, "class", "steps svelte-e7fcpv");
    			add_location(div0, file$2, 198, 0, 4278);
    			add_location(br0, file$2, 216, 0, 5208);
    			add_location(h21, file$2, 218, 4, 5238);
    			add_location(p1, file$2, 219, 4, 5258);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$2, 222, 12, 5411);
    			add_location(button0, file$2, 223, 12, 5466);
    			add_location(form0, file$2, 221, 8, 5350);
    			attr_dev(div1, "id", "nameofclass");
    			add_location(div1, file$2, 220, 4, 5319);
    			add_location(p2, file$2, 226, 4, 5530);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$2, 229, 12, 5667);
    			add_location(button1, file$2, 230, 12, 5718);
    			add_location(form1, file$2, 228, 8, 5612);
    			attr_dev(div2, "id", "addField");
    			add_location(div2, file$2, 227, 4, 5584);
    			attr_dev(div3, "id", "users");
    			add_location(div3, file$2, 234, 4, 5777);
    			attr_dev(div4, "class", "steps svelte-e7fcpv");
    			add_location(div4, file$2, 217, 0, 5214);
    			add_location(br1, file$2, 240, 0, 5912);
    			add_location(h22, file$2, 242, 4, 5942);
    			add_location(i2, file$2, 243, 54, 6012);
    			add_location(p3, file$2, 243, 4, 5962);
    			add_location(button2, file$2, 244, 4, 6054);
    			add_location(br2, file$2, 246, 13, 6124);
    			add_location(button3, file$2, 247, 4, 6134);
    			attr_dev(div5, "class", "steps svelte-e7fcpv");
    			add_location(div5, file$2, 241, 0, 5918);
    			add_location(br3, file$2, 252, 0, 6287);
    			add_location(h23, file$2, 254, 4, 6328);
    			add_location(p4, file$2, 255, 4, 6348);
    			attr_dev(p5, "class", "sourcecode svelte-e7fcpv");
    			add_location(p5, file$2, 256, 4, 6448);
    			attr_dev(div6, "id", "step2");
    			attr_dev(div6, "class", "steps svelte-e7fcpv");
    			add_location(div6, file$2, 253, 0, 6293);
    			add_location(br4, file$2, 258, 0, 6528);
    			add_location(h24, file$2, 260, 4, 6569);
    			add_location(p6, file$2, 261, 4, 6589);
    			attr_dev(p7, "class", "sourcecode svelte-e7fcpv");
    			add_location(p7, file$2, 262, 4, 6696);
    			attr_dev(div7, "id", "step3");
    			attr_dev(div7, "class", "steps svelte-e7fcpv");
    			add_location(div7, file$2, 259, 0, 6534);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*button1Text*/ 8) set_data_dev(t49, /*button1Text*/ ctx[3]);
    			if (!current || dirty & /*button2Text*/ 16) set_data_dev(t52, /*button2Text*/ ctx[4]);
    			if (!current || dirty & /*className*/ 4) set_data_dev(t60, /*className*/ ctx[2]);
    			if (!current || dirty & /*className*/ 4) set_data_dev(t62, /*className*/ ctx[2]);
